...
public class FrenchDeckREST {
	...
	public Response retrieveCardOnTop() {
		FrenchCard card = (FrenchCard) frenchDeckServices.getCardOnTop();
	...
	public Response retrieveCardOnBottom() {
		FrenchCard card = (FrenchCard) frenchDeckServices.getCardOnBottom();
		return buildResponse(card, HTTP_SUCCESS_200);
	}
	...
	public Response putCardOnTop(FrenchCard card) {
		// FIXME: Have to correct deserialization. @See https://github.com/FasterXML/jackson-docs/wiki/JacksonPolymorphicDeserialization
		// return buildResponse(frenchDeckServices.putCardOnTop(card), HTTP_SUCCESS_200);
	...
	public Response putCardOnBottom(FrenchCard card) {
		// FIXME: Have to correct deserialization. @See https://github.com/FasterXML/jackson-docs/wiki/JacksonPolymorphicDeserialization
		// return buildResponse(frenchDeckServices.putCardOnBottom(card), HTTP_SUCCESS_200);
		return buildResponse("Not available yet", HTTP_ERROR_400);
	}
